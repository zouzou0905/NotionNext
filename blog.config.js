...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://animated-bug-f8a.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '2e7283e4ee2281979304fba7fd0b5632',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wa1k', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || '嘻嘻🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wa1k.vercel.app/', // 网站地址
